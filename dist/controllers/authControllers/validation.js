...
exports.validateRegisterSchema = exports.validateUsernameSchema = exports.validateLoginSchema = void 0;
...
const validateUsernameSchema = (username) => {
    const schema = joi_1.default.object({
        username: joi_1.default.string().required().min(3).max(30),
    });
    return schema.validate({ username });
};
exports.validateUsernameSchema = validateUsernameSchema;
